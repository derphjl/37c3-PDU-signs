...
\begin{center}
\scalebox{2.6}{\texttt{PDU \scalebox{4}{\pdunumber}}}
\end{center}
...
\item\scalebox{\scalefaq}{{\textsf{What is a} \texttt{PDU} \textsf{and why does it have a sign?}}}

\textsf{\texttt{PDU} \textsf{=} \texttt{P}\textsf{ower} \texttt{D}\textsf{istribution} \texttt{U}\textsf{nit}\\We, the power team, are responsible for delivering safe and plentiful power to all participants of this event so everyone can power their gadgets, charge their computers and phones, etc.}
